...
export const staffMisc: Record<Locale, Record<string, string>> = {
  es: {
    ...
    'staffMisc.tables.viewList': 'Lista',
    'staffMisc.tables.viewFloorPlan': 'Plano de sala',
    'staffMisc.tables.viewBoard': 'Tablero',
    'staffMisc.tables.boardFilterAll': 'Todas',
    'staffMisc.tables.boardSelectPrompt': 'Selecciona una mesa para ver qué hacer.',
    'staffMisc.tables.boardNoOrders': 'Sin pedidos activos en esta mesa.',
    ...
    'staffMisc.kitchen.sendDirectToWaiter': 'Enviar directo al camarero',
    'staffMisc.kitchen.sendItemToWaiter': 'Mandar a camarero',
    'staffMisc.kitchen.itemSentToWaiter': 'Enviado al camarero',
  ...
  en: {
    ...
    'staffMisc.tables.viewList': 'List',
    'staffMisc.tables.viewFloorPlan': 'Floor plan',
    'staffMisc.tables.viewBoard': 'Board',
    'staffMisc.tables.boardFilterAll': 'All',
    'staffMisc.tables.boardSelectPrompt': 'Select a table to see what needs to happen.',
    'staffMisc.tables.boardNoOrders': 'No active orders on this table.',
    ...
    'staffMisc.kitchen.sendDirectToWaiter': 'Send straight to waiter',
    'staffMisc.kitchen.sendItemToWaiter': 'Send to waiter',
    'staffMisc.kitchen.itemSentToWaiter': 'Sent to waiter',
  ...
  pt: {
    ...
    'staffMisc.tables.viewList': 'Lista',
    'staffMisc.tables.viewFloorPlan': 'Planta da sala',
    'staffMisc.tables.viewBoard': 'Painel',
    'staffMisc.tables.boardFilterAll': 'Todas',
    'staffMisc.tables.boardSelectPrompt': 'Selecione uma mesa para ver o que fazer.',
    'staffMisc.tables.boardNoOrders': 'Sem pedidos ativos nesta mesa.',
    ...
    'staffMisc.kitchen.sendDirectToWaiter': 'Enviar direto ao garçom',
    'staffMisc.kitchen.sendItemToWaiter': 'Enviar ao garçom',
    'staffMisc.kitchen.itemSentToWaiter': 'Enviado ao garçom',
  ...
  de: {
    ...
    'staffMisc.tables.viewList': 'Liste',
    'staffMisc.tables.viewFloorPlan': 'Raumplan',
    'staffMisc.tables.viewBoard': 'Übersicht',
    'staffMisc.tables.boardFilterAll': 'Alle',
    'staffMisc.tables.boardSelectPrompt': 'Wähle einen Tisch, um zu sehen, was zu tun ist.',
    'staffMisc.tables.boardNoOrders': 'Keine aktiven Bestellungen an diesem Tisch.',
    ...
    'staffMisc.kitchen.sendDirectToWaiter': 'Direkt an den Kellner senden',
    'staffMisc.kitchen.sendItemToWaiter': 'An Kellner senden',
    'staffMisc.kitchen.itemSentToWaiter': 'An Kellner gesendet',
  ...
  fr: {
    ...
    'staffMisc.tables.viewList': 'Liste',
    'staffMisc.tables.viewFloorPlan': 'Plan de salle',
    'staffMisc.tables.viewBoard': 'Tableau',
    'staffMisc.tables.boardFilterAll': 'Toutes',
    'staffMisc.tables.boardSelectPrompt': 'Sélectionnez une table pour voir ce qu’il faut faire.',
    'staffMisc.tables.boardNoOrders': 'Aucune commande active sur cette table.',
    ...
    'staffMisc.kitchen.sendDirectToWaiter': 'Envoyer directement au serveur',
    'staffMisc.kitchen.sendItemToWaiter': 'Envoyer au serveur',
    'staffMisc.kitchen.itemSentToWaiter': 'Envoyé au serveur',
