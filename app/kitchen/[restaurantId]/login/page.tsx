 ...
 * "/kitchen/[restaurantId]/login" keep working — it just forwards to
 * the single login screen.
 */
export default function KitchenLoginRedirect() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-n2bNavy px-6">
      <p className="text-sm text-white/50">{t('authPages.redirecting')}</p>
    </main>
  );
}
