...
export async function GET(req: NextRequest, { params }: { params: { slug: string } }) {
  ...
  return NextResponse.json({
    restaurant: {
      ...
      menuLayoutMode: restaurant.menuLayoutMode,
      menuBackgroundBlur: restaurant.menuBackgroundBlur,
      menuBackgroundTint: restaurant.menuBackgroundTint,
      menuFontScale: restaurant.menuFontScale,
    },
    table: { id: table.id, label: table.label },
